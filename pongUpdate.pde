...
void setup() {
  ...
  file = new SoundFile(this, "4359__noisecollector__pongblipf4.wav");
  file2 = new SoundFile(this, "159375__greenhourglass__8-bit-boing.wav");
